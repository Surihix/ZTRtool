...
namespace ZTRtool.SupportClasses.KeyDictionaries
{
    internal class KeyDictsXIII2
    {
        ...
        public static Dictionary<(byte b1, byte b2), string> IconKeys = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xF0, 0x4A), "{Icon Tamed_Monsters}" },
            { (0xF0, 0x4B), "{Icon Untameable}" },
            { (0xF0, 0x4C), "{Icon Tameable}" },
            { (0xF0, 0x4D), "{Icon Casino_Coins}" },
            { (0xF0, 0x4E), "{Icon Passive_Nontransferable}" },
            { (0xF0, 0x4F), "{Icon Passive_Transferable}" },
        ...
        public static Dictionary<(byte b1, byte b2), string> ChIconKeys = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xFA, 0x4A), "{Icon Tamed_Monsters}" },
            { (0xFA, 0x4B), "{Icon Untameable}" },
            { (0xFA, 0x4C), "{Icon Tameable}" },
            { (0xFA, 0x4D), "{Icon Casino_Coins}" },
            { (0xFA, 0x4E), "{Icon Passive_Nontransferable}" },
            { (0xFA, 0x4F), "{Icon Passive_Transferable}" },
        ...
        public static Dictionary<(byte b1, byte b2), string> KrIconKeys = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xC9, 0xAB), "{Icon Tamed_Monsters}" },
            { (0xC9, 0xAC), "{Icon Untameable}" },
            { (0xC9, 0xAD), "{Icon Tameable}" },
            { (0xC9, 0xAE), "{Icon Casino_Coins}" },
            { (0xC9, 0xAF), "{Icon Passive_Nontransferable}" },
            { (0xC9, 0xB0), "{Icon Passive_Transferable}" },
