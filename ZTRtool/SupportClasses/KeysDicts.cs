...
namespace ZTRtool.SupportClasses
{
    internal class KeysDicts
    {
        ...
        public static Dictionary<(byte b1, byte b2), string> IconKeysXIII2 = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xF2, 0x75), "{Icon_F2 75}" }, // 13-2 icons end here
        ...
        public static Dictionary<(byte b1, byte b2), string> KrIconKeysXIII2 = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xFE, 0xD6), "{Icon_FE D6}" }, // 13-2 icons end here
        ...
        public static Dictionary<(byte b1, byte b2), string> ChIconKeysXIII2 = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xFB, 0x75), "{Icon_FB 75}" }, // 13-2 icons end here
        ...
        public static Dictionary<(byte b1, byte b2), string> KrBtnKeysXIII2 = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xC9, 0xE9), "{Btn RSUp}" },
            { (0xC9, 0xEA), "{Btn DPad}" },
            { (0xC9, 0xEB), "{Btn Analog}" },
            { (0xC9, 0xEC), "{Btn LStick}" },
            { (0xC9, 0xED), "{Btn NPad}" },
            { (0xC9, 0xEE), "{Btn LeftRightAnalogic}" },
            { (0xC9, 0xEF), "{Btn LeftRightPad}" },
            { (0xC9, 0xF0), "{Btn Arrows}" },
            { (0xC9, 0xF1), "{Btn PadLeft}" },
            { (0xC9, 0xF2), "{Btn A_2}" },
            { (0xC9, 0xF3), "{Btn B_2}" }
        };
        ...
        public static Dictionary<(byte b1, byte b2), string> ChBtnKeysXIII2 = new Dictionary<(byte b1, byte b2), string>
        {
            ...
            { (0xFA, 0xBA), "{Btn RSUp}" },
            { (0xFA, 0xBB), "{Btn DPad}" },
            { (0xFA, 0xBC), "{Btn Analog}" },
            { (0xFA, 0xBD), "{Btn LStick}" },
            { (0xFA, 0xBE), "{Btn NPad}" },
            { (0xFA, 0xBF), "{Btn LeftRightAnalogic}" },
            { (0xFA, 0xC0), "{Btn LeftRightPad}" },
            { (0xFA, 0xC1), "{Btn Arrows}" },
            { (0xFA, 0xC2), "{Btn PadLeft}" },
            { (0xFA, 0xC3), "{Btn A_2}" },
            { (0xFA, 0xC4), "{Btn B_2}" }
        };
        #endregion
